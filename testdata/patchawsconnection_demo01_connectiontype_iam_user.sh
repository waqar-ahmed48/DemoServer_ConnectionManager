...
curl -X PATCH http://localhost:5678/v1/connectionmgmt/connection/aws/$CONNECTIONID \
    ...
    -d "{\"connection\": {\"name\": \"Demo01Account_AWS_1_New\",\"description\": \"Demo01Account AWS Account description_1_New\",\"connectiontype\": \"\"}, \"accesskey\": \"$ACCESS_KEY\", \"secretaccesskey\": \"$SECRET_KEY\", \"default_region\": \"us-west-2\", \"default_lease_ttl\": \"30s\", \"max_lease_ttl\": \"70s\", \"role_name\": \"DemoUser\", \"credential_type\": \"iam_user\", \"policy_arns\": [\"arn:aws:iam::aws:policy/AdministratorAccess\"]}" | jq